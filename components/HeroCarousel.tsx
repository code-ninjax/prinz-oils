...
const slides = [
  {
    title: 'Powering the Future of Global Energy',
    description: 'Prinz Oil is a premier Nigerian energy company dedicated to sustainable exploration, refining, and distribution.',
  ...
  {
    title: 'Innovative Refining Solutions',
    description: 'Utilizing state-of-the-art technology to produce high-quality petroleum products for a growing market.',
  ...
  {
    title: 'Strategic Global Distribution',
    description: 'Connecting energy resources to markets efficiently and reliably through our integrated logistics network.',
